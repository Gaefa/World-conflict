...
export interface Translations {
  ...
  card_req_militaryTech: string;
  card_research_busy: string;
  card_not_ready: string;
  card_no_budget: string;
  card_name_research_military: string;
  card_desc_research_military: string;
  card_name_research_economy: string;
  card_desc_research_economy: string;
  card_name_research_covert: string;
  card_desc_research_covert: string;
  card_name_tax_raise: string;
  card_desc_tax_raise: string;
  card_name_tax_cut: string;
  card_desc_tax_cut: string;
  card_name_manipulate_price: string;
  card_desc_manipulate_price: string;
  card_name_sanction_evasion: string;
  card_desc_sanction_evasion: string;
  card_name_arms_deal: string;
  card_desc_arms_deal: string;
  card_name_spy_op: string;
  card_desc_spy_op: string;
  card_name_counter_intel: string;
  card_desc_counter_intel: string;
  card_name_propaganda: string;
  card_desc_propaganda: string;
  card_name_sabotage: string;
  card_desc_sabotage: string;
  card_name_coup: string;
  card_desc_coup: string;
